...
PROXY_DIR="$CODEX_DIR/codex-universal-proxy"
PROXY_JS="$PACKAGE_DIR/proxy.js"
PLIST="$HOME/Library/LaunchAgents/com.user.codex-universal-proxy.plist"
LABEL="com.user.codex-universal-proxy"
PROXY_PORT="${PROXY_PORT:-11436}"
UPSTREAM_PORT="11434"
CONFIG="$CODEX_DIR/config.toml"
REFERENCE="$CODEX_DIR/config.toml.codex-universal-proxy"
SKILL="$PACKAGE_DIR/model_config.js"
